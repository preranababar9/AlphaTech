...
{/* first div */}
        ...
        <div className="flex justify-between mb-20 flex-wrap max-md:gap-y-7">
          ...
          <p className="text-lg max-md:text-md  w-[330px] max-md:w-[300px]">1st Floor, City Mall, Dares Salaam,Junction of Bibi Titi Mohamed, Morogoro Road</p>
        ...
        <div className="flex text-white justify-between gay-5 mt-10  max-md:flex-col-reverse  max-md:gap-y-5">
                <p className="max-md:text-center max-md:text-sm text-lg">Copyright © 2024 Alphatechtz.com All rights reserved | Designed & Developed by <span className="text-[#22C55E]">DotSyndicate</span></p>
